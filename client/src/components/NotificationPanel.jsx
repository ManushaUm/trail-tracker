...
const notifyIcon = {
  alert: (
    <HiBellAlert className="h-5 w-5 text-gray-600 group-hover:text-red-400" />
  ),
  message: (
    <BiSolidMessageRounded className="h-5 w-5 text-gray-600 group-hover:text-red-400" />
  ),
};
